...
The public API lives at the module root (`github.com/go-ruby-sidekiq/sidekiq`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `sidekiq`, while the surface follows
...
```go
import "github.com/go-ruby-sidekiq/sidekiq"
```
...
- **[pkg.go.dev/github.com/go-ruby-sidekiq/sidekiq](https://pkg.go.dev/github.com/go-ruby-sidekiq/sidekiq)**

The module's [README](https://github.com/go-ruby-sidekiq/sidekiq#readme) carries worked
