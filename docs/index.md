# go-ruby-sidekiq documentation

**Pure-Go, MRI-4.0.5-faithful Ruby sidekiq (no cgo)**

`go-ruby-sidekiq/sidekiq` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `sidekiq`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `sidekiq`, validated against reference Ruby, at 100%
...
```sh
go get github.com/go-ruby-sidekiq/sidekiq
```
...
| Repo | What it is |
| --- | --- |
| [`sidekiq`](https://github.com/go-ruby-sidekiq/sidekiq) | the library — Ruby's `sidekiq` in pure Go |
| [`docs`](https://github.com/go-ruby-sidekiq/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-sidekiq.github.io`](https://github.com/go-ruby-sidekiq/go-ruby-sidekiq.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-sidekiq/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-sidekiq/sidekiq](https://github.com/go-ruby-sidekiq/sidekiq).
